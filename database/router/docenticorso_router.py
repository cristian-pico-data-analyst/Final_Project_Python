...
# ==========================================
@router.get("/GET_ALL_DOCENTICORSO", summary = "Recupera le informazioni di tutte le ID collegate alla correlazione Docenti/Corsi")
...
# ==========================================
@router.get("/GET_DOCENTICORSO_BY_ID", summary = "Recupera le informazioni di una singolo ID in DocentiCorso")
...
# ==========================================
@router.post("/ADD_DOCENTICORSO", summary = "Inserisce le informazioni di un nuovo collegamento docenti e id")
def add_DC(
        docenti_id: int,
        corso_id: int,
...
# ==========================================
@router.delete("/DELETE_DOCENTI_CORSO", summary = "Elimina le informazioni di correlazione docenti e id")
...
# ==========================================
@router.put("/UPDATE_DOCENTICORSO_BY_ID", summary = "Aggiorna le informazioni di una correlazione Docente/Corso tramite ID")
def update_dc(
        dc_id: int,
        docente_id: int = None,
        corso_id: int = None,
