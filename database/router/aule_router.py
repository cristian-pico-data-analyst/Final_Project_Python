...
# ==========================================
@router.get("/GET_ALL_AULE", summary = "Recupera le informazioni di tutti le aule")
...
# ==========================================
@router.get("/GET_AULA_BY_ID", summary = "Recupera le informazioni di una singola aula tramite ID")
...
# ==========================================
@router.delete("/DELETE_AULA", summary = "Elimina le informazioni di un' aula")
...
# ==========================================
@router.put("/UPDATE_AULA_BY_ID", summary = "Aggiorna le informazioni di un' aula tramite ID")
def update_aule(
        aula_id: int,
        nome_aula: str = None,
        capacita: str = None,
