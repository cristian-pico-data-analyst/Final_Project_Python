...
# ==========================================
@router.get("/GET_ALL_CORSI", summary = "Recupera le informazioni di tutti gli studenti")
...
# ==========================================
@router.get("/GET_CORSI_BY_ID", summary = "Recupera le informazioni di un singolo corso")
...
# ==========================================
@router.delete("/DELETE_CORSI_BY_ID", summary = "Elimina le informazioni di un corso")
...
# ==========================================
@router.put("/UPDATE_CORSI_BY_ID", summary = "Aggiorna le informazioni di un corso")
def update_corsi(
        corso_id: int,
        nome_corso: str = None,
