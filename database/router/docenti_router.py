...
# ==========================================
@router.get("/", summary="Recupera le informazioni di tutti i docenti")
...
# ==========================================
@router.get("/{docente_id}", summary="Recupera un singolo docente tramite ID")
...
# ==========================================
@router.get("/cerca/{docente_surname}", summary="Ricerca le informazioni di un docente tramite cognome")
def get_docentebysurname(docente_surname: str, conn=Depends(get_database)):
    """
    Recupera i dati di un singolo docente in base al nome passato nell'URL.
    """
    cursor = conn.cursor()
...
# ==========================================
@router.delete("/Delete/{docente_id}", summary="Elimina le informazioni di un docente")
...
# ==========================================
@router.put("/Update/{docente_id}", summary = "Aggiorna le informazioni di un docente")
def update_docente(
        docente_id: int,
        nome: str,
        cognome: str,
